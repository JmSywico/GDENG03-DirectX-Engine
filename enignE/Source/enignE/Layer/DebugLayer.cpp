...
void DebugLayer::OnImGuiRender()
{
	...
	ImGui::SetNextWindowSize(enignE::Editor::UI::Scale(430.0f, 420.0f), ImGuiCond_FirstUseEver);
	...
	ImGui::PlotLines(
		...
		enignE::Editor::UI::Scale(0.0f, 90.0f),
		sizeof(float));
	...
	ImGui::PlotLines(
		...
		enignE::Editor::UI::Scale(0.0f, 54.0f), sizeof(float));
